        ...
        <div class="sidebar-wrapper" data-simplebar="true">
            <div class="sidebar-header">
                <a href="{{ url('/admin/dashboard') }}" class="d-flex align-items-center">
                    <img src="{{ $user->company_logo ? asset('storage/' . $user->company_logo) : asset('assets/img/logos/logo.png') }}"
                        class="logo-icon" alt="logo icon" alt="MedTech">
            ...
            <ul class="metismenu" id="menu">
                ...
                <li>
                    ...
                    <ul>
                        ...
                        <li> <a href="{{ url('/admin/add-product') }}"><i class='bx bx-radio-circle'></i>Add
                                Product</a>
                        </li>
                    </ul>
                </li>
                ...
                <li>
                    ...
                    <ul>
                        <li> <a href="{{ url('/admin/certificate-list') }}"><i
                                    class='bx bx-radio-circle'></i>Certificate
                                List</a>
                        </li>
                        <li> <a href="{{ url('/admin/add-certificate') }}"><i class='bx bx-radio-circle'></i>Add
                                Certificate</a>
                        </li>
                    </ul>
                </li>
                <li>
                    ...
                    <ul>
                        <li> <a href="{{ url('/admin/exhibition-list') }}"><i class='bx bx-radio-circle'></i>Exhibition
                                List</a>
                        </li>
                        <li> <a href="{{ url('/admin/add-exhibition') }}"><i class='bx bx-radio-circle'></i> Add
                                Exhibition</a>
                        </li>
                        <li> <a href="{{ url('/admin/book-appointments') }}"><i class='bx bx-radio-circle'></i>
                                Exhibition Appointments</a>
                        </li>
                    </ul>
                </li>
                <li>
                    ...
                    <ul>
                        <li> <a href="{{ url('/admin/banner-list') }}"><i class='bx bx-radio-circle'></i>Home Banner
                                List</a>
                        </li>
                        <li> <a href="{{ url('/admin/home-banner') }}"><i class='bx bx-radio-circle'></i> Add Home
                                Banner</a>
                        </li>
                    </ul>
                </li>
                    ...
                    <div class="user-box dropdown px-3">
                        ...
                        <ul class="dropdown-menu dropdown-menu-end">
                            <li><a class="dropdown-item d-flex align-items-center"
                                    href="{{ route('admin.company.profile') }}"><i
