    ...
    <div class="page-content">
        ...
        <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb mb-0 p-0">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Exhibition Appointments</li>
                </ol>
            </nav>
        </div>
        <!--end breadcrumb-->
        ...
        <div class="card">
            <div class="card-header d-flex justify-content-between align-items-center">
                <h5 class="mb-0">Exhibition Appointment List</h5>
            </div>
                ...
                <table id="example" class="table table-responsiv" style="width:100%">
                    <thead class="table-light">
                        <tr>
                            ...
                            <th class="text-center text-nowrap">Customer Details</th>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a
                                        ...
                                        <div class="user-info">
                                            <p class="category user-name mb-0">{{ $exhibition->exhibition ?? 'N/A' }}</p>
                                        </div>
                                    </a>
                                </td>
                                <!--<td class="text-center">{{ $exhibition->product->category->category_name ?? 'N/A'  }}</td>-->

                                <!--<td class="text-center">{{ $exhibition->product_name}}</td>-->
                                <td class="text-center">{{ $exhibition->name }}<br>{{ $exhibition->email }}<br>{{ $exhibition->phone }}</td>
                                <td class="text-center text-nowrap">Country: {{ $exhibition->country }}<br>Role: {{ $exhibition->role }}</td>
                                <td class="text-center text-nowrap">{{ $exhibition->subject }}</td>
                                <td class="text-center">{{ $exhibition->message }}</td>
