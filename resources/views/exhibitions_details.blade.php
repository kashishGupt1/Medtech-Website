...
.lg-outer,
.lg {
    z-index: 99999999 !important; /* Ensure this is higher than the header's z-index */
    position: fixed; /* This makes sure the gallery stays in place */
    top: 0;
    left: 0;
    width: 100%;
    height: 100%;
}
   </style><section class="page-title-section top-position1 bg-img cover-background left-overlay-dark" data-overlay-dark="6">
            <div class="container">
                    ...
                    <div class="col-lg-12">
                        <article class="card card-style3 border-0 h-100">
                            <div class="card-body p-1-9 position-relative">
                                ...
                                <ul class="mb-2 p-0">
                                    <li class="display-30 d-inline-block text-capitalize me-3"><i class="fa fa-calendar text-primary pe-2"></i>{{ \Carbon\Carbon::parse($exhibition->exhibition_date)->format('d-m-Y') }}</li>
                                    <li class="display-30 d-inline-block"><i class="fa fa-location-dot text-primary pe-2"></i>{{ $exhibition->exhibition_location }}</li>
                                </ul>
                                    ...
                                    @foreach (json_decode($exhibition->exhibition_images) as $image)
                                        ...
                                        >
                                          <img
                                            ...
                                            src="{{ asset('storage/' . $image) }}"  alt="{{$exhibition->exhibition_name}}"
                                          />
                                        </a>
